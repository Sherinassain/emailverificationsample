...
class Account_creation extends StatelessWidget {
  const Account_creation({super.key});
    ...
    return Scaffold(
      body: SafeArea(child: Padding(
        ...
        decoration: BoxDecoration(color: Colors.transparent,image: DecorationImage(image: NetworkImage('https://yt3.ggpht.com/OWAcq1Yu0stdx87oWaZNPMLWYhAyrGhmDTPyi13jlmfAGkkLO5RgYnLGoaXqG_ZOWXCiuqKk=s900-c-k-c0x00ffffff-no-rj'),fit: BoxFit.cover)),
          ...
          constantheight,
          Text('You are successfully Created an account',style: TextStyle(color: Colors.green,fontWeight: FontWeight.w600,fontSize: 20),)
,          Text('Pls Login for further deatils',style: TextStyle(color: Colors.green,fontWeight: FontWeight.w600,fontSize: 20),)
,constantheight,
